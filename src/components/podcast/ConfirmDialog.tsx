      ...
      <div role="alertdialog" aria-modal="true" aria-labelledby="confirm-message" className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row-reverse">
          <button
            type="button"
            onClick={onConfirm}
            className={`min-h-14 flex-1 rounded-full px-6 text-lg font-bold text-white ${danger ? "bg-red-700 hover:bg-red-800" : "bg-medical hover:bg-medical-dark"}`}
          >
            {confirmLabel}
          </button>
          <button
            ...
            type="button"
            onClick={onCancel}
            className="min-h-14 flex-1 rounded-full bg-white px-6 text-lg font-bold text-navy ring-2 ring-inset ring-slate-400 hover:bg-mist"
          >
            Cancel
          </button>
        </div>
